...
canonical pipeline/momentum_filter.py (top level), which is what run_pipeline.sh and
...
treat pipeline/momentum_filter.py as the source of truth and edit that one.
"""
"""
