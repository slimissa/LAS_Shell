...
canonical pipeline/size_positions.py (top level), which is what run_pipeline.sh and
...
treat pipeline/size_positions.py as the source of truth and edit that one.
"""
"""
