...
while [ $CYCLE -le $CYCLES ]; do
    ...
    python3 $LAS_SHELL_HOME/scripts/market_maker.py $TICKER --size $QUOTE_SIZE --spread_bps $SPREAD_BPS --max_pos $MAX_INVENTORY \
        ?> python3 $LAS_SHELL_HOME/scripts/risk_check.py --max_notional 100000 --max_size $MAX_INVENTORY \
