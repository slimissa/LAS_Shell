#!/usr/bin/env python3
"""
Las_shell Pairs Spread Engine — pairs_spread.py
...
⚠ SYNTHETIC DATA — TESTING ONLY: spread/price series are simulated
(seeded randomness), not real correlated-asset price history. Useful
for exercising the pipeline, not for evaluating strategy performance.
"""
import sys
import random
import hashlib
