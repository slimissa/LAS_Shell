...
def _save_state():
    try:
        ...
        # FIX SV1: match the 0600 permissions already used for the real
        # paper account file -- this state also holds cash/position data
        # and shouldn't be left world-readable.
