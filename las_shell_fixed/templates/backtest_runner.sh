...
python3 -c "import os; os.makedirs(os.environ.get('LOGDIR', os.path.join(os.environ.get('HOME','.'), 'las_shell_logs')), exist_ok=True)"
...
python3 $PIPELINE/universe.py \
    | python3 $PIPELINE/momentum_filter.py --lookback 20 --topn 10 \
