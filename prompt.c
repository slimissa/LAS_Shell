 ...
 * ~/.qshell_market : "OPEN 47" / "CLOSED 387" / "PRE 12" / "AFTER 23"
 * ~/.qshell_pnl    : "+1240.50" or "-320.00"                           */
#define MARKET_FILE "/.qshell_market"
#define PNL_FILE    "/.qshell_pnl"
