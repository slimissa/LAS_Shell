...
⚠ SYNTHETIC DATA — TESTING ONLY: this is a simulated price generator
(seeded randomness), not a real market data feed. Same caveat as
scripts/price_feed.py -- useful for exercising the pipeline, not for
