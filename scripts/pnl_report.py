#!/usr/bin/env python3
"""
QShell P&L Reporter — pnl_report.py
...
def main():
    args = sys.argv[1:]
    log_file = os.path.join(os.environ.get("QSHELL_HOME", "."), "logs", "executions.csv")
    fmt = "text"
    i = 0
    while i < len(args):
    ...
    # Write to ~/.qshell_pnl for prompt display
    home = os.environ.get("HOME", ".")
    pnl_file = os.path.join(home, ".qshell_pnl")
